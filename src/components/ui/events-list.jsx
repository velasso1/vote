        ...
        <div className="events__filter">
          {isAdmin && (
            <div className="events__admin-menu">
              <button className="events__admin-button" onClick={(e) => navigate('/create-user')}>
                Создать учетную запись
              </button>
              <button className="events__admin-button" onClick={(e) => navigate('/create-event')}>Создать событие</button>
            </div>
          )}
